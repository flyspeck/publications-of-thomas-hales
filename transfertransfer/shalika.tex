...
$G^{**}_{\op{adj}}$,
	\undefined{Why does `adj' get a Roman subscript
(although it should be \verb+\text+ instead of \verb+\op+),
whereas the others are in math mode?}
$\op{Aut}_0(G^{**})$, and even $(G^{**}_{sc}\times
