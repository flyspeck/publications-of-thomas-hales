...
S_{sc}/W^\theta$.  \XX{properly finish this argument.}  The torus
...
We fix data $(\hat U,\hat B_1,\iota,\phi,\epsilon)$ associated with
...
%\[
% P(\hat G,M(\xi,\theta_1),\dotw\theta,E,1) = 
