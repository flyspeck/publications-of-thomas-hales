...
Roots $\beta\in\Phi$ (or in $\Phi^\vee$)
...
%dual relationship between norms and restriction, for $\Sigma_1 = (\Sigma_{red})^\vee$ 
%in Equation \ref{eqn:norm}, the corollary follows.
\end{proof}
...
% = \prod_{\alpha^\vee\in \Sigma^+_1} c'_{\alpha^\vee}(s^{-1}).
\]
We claim that
