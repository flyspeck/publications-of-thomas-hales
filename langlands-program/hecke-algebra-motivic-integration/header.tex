...
for constructible motivic functions.    To carry this out,
...
These partition functions are used to extend numerous results that were previously known only when ${}^LG=\hat G$ is
