...
In terms of the local coordinates of Section~\rif{sec:coords}, if $x_1=x_2=x_3=x_4=0$ defines the $K$-dimer, then the explicit
...
Section~\rif{sec:dimer-pair} describes the proof of the local minimality of the $K$-dimer.  We review that
...
in an explicit neighborhood of the $K$-dimer.  In Section~\rif{sec:dimer-pair}, we give a curve $\Gamma$ 
