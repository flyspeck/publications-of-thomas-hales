...
Let us fix an element of the set of fixed choices $\cF$. 
That determines the cocycle space $Z$ 
...
Loren says:
$$\Theta_\pi(\mexp(Y))= \sum_{\cO\in \cO(X)} c_\cO\widehat\mu_{\cO}(Y),$$
